...
const Apply:NextPage = () => {
    ...
    const  {activeStep,isLastStep,next,back,details,activeStepValidation,getStepLength} = useMultiForm(steps);


    const submitApplyForm = (values: ApplyFormDetails, action: FormikHelpers<ApplyFormDetails>) => {
        action.setSubmitting(false);
        next();
    }


    const handleApplyForm = (values: ApplyFormDetails, action: FormikHelpers<ApplyFormDetails>) => {
        console.log(values);
        if (isLastStep) {
